...
#             data1 =Payout.objects.filter(payout_name="rupali").values()
#             print(data1)
#             return render(request,'policylist/policy_save.html', {'data1':data1})
#         except Payout.DoesNotExist:
#             return render(request,'policylist/policy_save.html')'31758AC'
# def apply_policy(request, id):
#     data=Policy.objects.get(policyid='57F8DFA')
#     d = data.OD_premium
    
#     data1=Payout.objects.get(payoutid='C155311')
...
#     # print(data./\)
#     data1=Payout.objects.filter(Q(case_type=case_data) & Q(fuel_type=fuel_data) & Q(Insurance_company=ins_data) & Q(rto=reg))
#     # data1=Payout.objects.get(payoutid=data1.payoutid)
#     # print(data1.rewards_on)
#     y =data1.rewards_age
#     a= data1.self_rewards_age
#     z = (d/y)
...
#         data=Policy.objects.filter(policy_no=id)
#         data.update(policy_no=policy_no, registration_no=registration, casetype=case_type, insurance_comp=ins_company, sp_name=service_provider, sp_brokercode=code, issueDate=issue_date,riskDate=risk_date,
...
#         return redirect("policylist/slab_payoutform")
#     else:
...
#         reg=data.registration_no[0:4]    
#         # print(data./\)
#         data3=Payout.objects.get(Q(case_type=case_data) & Q(fuel_type=fuel_data) & Q(Insurance_company=ins_data) & Q(rto=reg))
#         # data1=Payout.objects.get(payoutid=data.payoutid)
#         # print(data1.rewards_on)
#         print(data3.rewards_age)
#         print(data2.policy_no)
        
#         return render(request, "policylist/policy_entrydata.html", {'data2':data2,'data3':data3,'alldata':alldata})
...
def policy_entrydata(request, id):
    if request.method=="GET":
        ...
        return render(request,'policylist/edit_policy.html',{'data2':data2,'datasp':datasp,'databc':databc,'datamb':datamb, 'datavm':datavm, 'datavc':datavc,'datag':datag,'datai':datai})
    else:
        policy_no=request.POST['policy_no']
        registration=request.POST['registration']
        case_type=request.POST['case_type']
...
#     else:
#         data2=Policy.objects.get(policy_no=id)
#         # data3=Payout.objects.get(policy_no=id)
#         data2=Policy.objects.get(policyid=data2.policyid)
#         print(data2.policy_no)
#         d = data2.OD_premium
#         dt = data2.TP_premium
#         case_data=data2.casetype
#         fuel_data=data2.vehicle_fuel_type
#         ins_data=data2.insurance_comp
#         reg=data2.registration_no[0:4]    
#         # print(data./\)
#         data3=Payout.objects.get(Q(case_type=case_data) & Q(fuel_type=fuel_data) & Q(Insurance_company=ins_data) & Q(rto=reg))
